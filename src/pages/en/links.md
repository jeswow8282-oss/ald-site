...
description: "International resources on ALD — ALD Info, the ABCD1 Variant Registry, ALD Connect, and the consensus recommendations."
---
...
→ [Why it happens, and why it differs between people](/en/pathogenesis)
...
|---|---|---|
| [ALD Life](https://www.aldlife.org/) | UK | Patient and family support, practical guidance |
| [Stop ALD Foundation](http://www.stopald.org/) | USA | Focused on accelerating research |
| [ALD Alliance](https://www.aldalliance.org/) | USA | Newborn screening advocacy |
| [United Leukodystrophy Foundation](https://ulf.org/) | USA | Leukodystrophies generally |
| [ELA International](https://elainternational.eu/) | Europe | Leukodystrophies generally, European advocacy |
| [a future](https://www.a-future.jp/) | Japan | Japanese ALD patient organisation |

---

## Finding clinical trials

**[ClinicalTrials.gov](https://clinicaltrials.gov/search?cond=adrenoleukodystrophy)** — the US National Institutes of Health registry. Searching `adrenoleukodystrophy` returns trials running worldwide.

→ The main trials are summarised on our [Clinical Trials](/en/clinical-trials) page.
